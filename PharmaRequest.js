...
const [isPharmacistRegistered, setIsPharmacistRegistered] = useState(false);
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        const p={username,name,email,password,hourly_rate,affiliation,educational_background,workingLicense,pharmacistDegree,pharmacistId}
        try {
              ...
              setEducational_background(e.target.value)
                ...
                <div className="form-group">
                  ...
                  <input
                    ...
                    id="pharmacistDegree"
                    accept=".pdf"
                    onChange={(e) => setPharmacistDegree(e.target.files[0])}
                  />
                </div>
                {/* Pharmacist ID PDF */}
                <div className="form-group">
                  ...
                  <input
                    ...
                    id="pharmacistId"
                    accept=".pdf"
                    onChange={(e) => setPharmacistId(e.target.files[0])}
                  />
                </div>
